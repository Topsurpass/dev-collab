			...
			<div className="w-full max-w-md space-y-6 text-center">
				<div className="space-y-3">
					...
					<p className="text-gray-500 dark:text-gray-400">
						The requested resource could not be located. Please verify the URL or
						navigate back to our platform.
					</p>
				</div>
				...
				<p className="mt-8 text-sm text-gray-500 dark:text-gray-400">
					...
					<a href="/support" className="text-rose-600 hover:underline dark:text-rose-400">
						support team
					</a>
				</p>
			</div>
