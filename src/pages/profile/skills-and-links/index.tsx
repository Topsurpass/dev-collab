...
import { type UserSkillsLinksInput, userSkillsAndLinksSchema } from '@/validations/profile-schema';
import { Button } from '@/components/ui/button';
import QueryKeys from '@/api/query-keys';
import useProfileUpdate from '@/api/authentication/use-profile-update';
import { ProfileSkillsFormSkeleton } from '@/components/skeletons/profile-skeleton';
						...
						<CardContent>
							<div className="flex w-full justify-end">
								<Button
									...
									className="flex gap-2 rounded-3xl border"
									variant="outline"
								>
									<CiEdit size={20} /> Edit
								</Button>
